...
author: Emissions and Energy Modeling Group
...
-   Impact of VMT-Mix on On-Road Emission Inventories (EIs) Running Emissions:
...
The VMT-Mix table has 60,000 rows (25 \* 5 \* 5 \*4 \* 24). It is developed for the following:
...
The following figure shows that 25^th^ to 75^th^ percentile values are $-6\%$ to $9\%$. 5th to 95th percentiles are $-25\%$ and $28\%$. Indicating for the majority of the VMT-Mix row's there is little change between FY22 and FY23 VMT-Mix.
...
::: {.column width="50%"}
![Statewide Change in Emission (FY23 vs. FY22 VMT-Mix)](statewide_fy23_fy22_PerDiff.png){alt="Statewide Change in Emission (FY23 vs. FY22 VMT-Mix)" fig-align="center" width="95%"}
:::
:::
...
\endgroup
```
## FY23 VMT-Mix vs. FY22 VMT-Mix Ozone Non-Attainment Area NOx EI Impact

Bexar (AACOG) has a $\sim 7.4%$ increase, Tarrant (NCTCOG) has $\sim 3.4%$, and Dallas has $\sim 0.25%$ increase. All other counties have no change or a reduction.
...
::: {.column width="50%"}
![FY23 vs. FY22 VMT-Mix Impact on Ozone Non-Attainment Counties (%)](nox_nonatt_fy23_fy22_PerDiff.png){fig-align="center" width="95%"}
:::
:::

## FY23 VMT-Mix vs. FY22 VMT-Mix PM10 Non-Attainment Area EI Impact
...
-   The emission decrease by 0.03 short-tons/day; a $\sim 2.9\%$ decrease.
...
-   Diesel combination trucks have $\sim 40$ times higher emission rate than gasoline passenger cars.
...
-   Certain pollutants emission rates vary a lot by SUT+FT (diesel CLhT, CShT, RT... for NOx). Any error in VMT-Mix will amplify emissions a lot depending on the SUT+FT being affected.

-   From a national perspective, using defaults versus state-specific methodology to get VMTs by SUT+FT can lead to very different emissions. Need to have *uniformity in VMT-Mix estimation across states.*

-   Given the high sensitivity to VMT-Mix, there is *need to have a standalone study* for VMT-Mix estimation.

### Next Steps
-   Work on Memo for Task 5.3 VMT-Mix based on this ppt's structure.

-   Finalize literature review on VMT-MIx development methodologies.
