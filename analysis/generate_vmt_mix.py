...
def main():
    ...
    ii_dow_by_cls_fact_calc.dow_by_cls_fac(
        out_fi="conv_aadt2dow_by_vehcat.tab", min_yr=2013, max_yr=2021
    )
    ...
    iii_adt_to_aadt_fac.mth_dow_fac(
        out_fi="conv_aadt2mnth_dow.tab", min_yr=2013, max_yr=2021
    )
    # Compute the HPMS category counts from the MVC data and apply the above conversion
    # factors.
    iv_mvc_hpms_counts.mvc_hpms_cnt(out_fi="mvc_vmtmix", min_yr=2013, max_yr=2021)
